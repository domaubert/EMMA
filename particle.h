...
REAL comptstep(int levelcoarse,int levelmax,struct OCT*** octList, REAL fa, REAL fa2, struct CPUINFO* cpu,REAL);
...
void L_levpart(int level,struct OCT** firstoct,int is, struct CPUINFO *cpu);
