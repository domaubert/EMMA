...
rep="./data/";ncpu=32;execut="./utils/oct2grid ";sbox=64.;isnap=11;
...
t=alloct(swrite(format=rep+"grid.%05d",isnap),15,707,a,ncpu=32,execut="utils/alloct ")(5,);
d=alloct(swrite(format=rep+"grid.%05d",isnap),15,101,a,ncpu=32,execut="utils/alloct ");
x=alloct(swrite(format=rep+"grid.%05d",isnap),15,706,a,ncpu=32,execut="utils/alloct ")(5,);
p=alloct(swrite(format=rep+"grid.%05d",isnap),15,105,a,ncpu=32,execut="utils/alloct ")(5,);
l=d(4,);
d=d(5,);
