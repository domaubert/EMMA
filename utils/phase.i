...
rep="./data/";ncpu=32;execut="./utils/oct2grid ";sbox=4.;isnap=35;
//rep="./data_12_noschaye_nosrc/";ncpu=32;execut="./utils/oct2grid ";sbox=12.;isnap=19;
...
t=alloct("data/grid.00035",15,707,a,ncpu=32,execut="utils/alloct ")(5,);
d=alloct("data/grid.00035",15,101,a,ncpu=32,execut="utils/alloct ");
x=alloct("data/grid.00035",15,706,a,ncpu=32,execut="utils/alloct ")(5,);
p=alloct("data/grid.00035",15,105,a,ncpu=32,execut="utils/alloct ")(5,);
l=d(4,);
d=d(5,);
